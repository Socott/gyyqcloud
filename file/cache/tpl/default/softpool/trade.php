...
<tr>
<td class="tab" id="action"><a href="?action=index"><span>试用的订单(我是卖家)</span></a></td>
<td class="tab" id="action_order"><a href="?action=order"><span>买到的软件(我是买家)</span></a></td>
...
<?php } ?>
<script type="text/javascript">s('trade_softpool');m('action');</script>
<?php } ?>
