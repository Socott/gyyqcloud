...
<tr>
<td class="tab" id="action"><a href="?action=index"><span>我发布的专家</span></a></td>
<td class="tab" id="action_order"><a href="?action=order"><span>我预约的专家</span></a></td>
...
<?php } ?>
<script type="text/javascript">s('trade_expertpool');m('action_bind');</script>
...
<script type="text/javascript">s('trade_expertpool');m('action');</script>
...
<td class="tr">
<?php echo $td['itemid'];?>
<?php if($DT['trade']) { ?>(<?php echo $DT['trade_nm'];?>&nbsp;&nbsp;&nbsp;&nbsp;专家单号:<a href="https://lab.alipay.com/consume/queryTradeDetail.htm?tradeNo=<?php echo $td['trade_no'];?>" target="_blank" class="t"><?php echo $td['trade_no'];?></a>)<?php } ?>
<?php if($td['seller'] == $_username) { ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?action=update&step=print&itemid=<?php echo $itemid;?>" target="_blank" class="t">[打印专家]</a><?php } ?>
</td>
</tr>
<tr>
<td class="tl">专家名称</td>
...
<script type="text/javascript">s('trade_expertpool');m('<?php echo $nav;?>');</script>
...
<tr>
<td class="tl">专家单号</td>
<td class="tr"><?php echo $td['itemid'];?><?php if($DT['trade']) { ?>&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo $DT['trade_nm'];?>专家单号:<?php echo $td['trade_no'];?>)<?php } ?>
</td>
</tr>
<tr>
<td class="tl">专家名称</td>
...
<script type="text/javascript">s('trade_expertpool');m('action_order');</script>
...
<input type="hidden" name="title" value="[发货提醒]专家(ID:<?php echo $itemid;?>)已经付款，请尽快发货" />
<textarea name="content" style="display:none;">
<?php echo $td['seller'];?>，您好：<br/>
专家 <a href="<?php echo $MOD['linkurl'];?>trade.php?action=update&step=detail&itemid=<?php echo $itemid;?>" target="_blank"><?php echo $td['title'];?> (ID:<?php echo $itemid;?>)</a> 已经付款。请尽快发货！
</textarea>
</form>
<script type="text/javascript">s('trade_expertpool');m('action_order');Dd('remind').submit();</script>
...
<script type="text/javascript">s('trade_expertpool');m('action_express');</script>
...
专家ID：<input type="text" size="10" name="mallid" value="<?php echo $mallid;?>"/>&nbsp;
...
"><a href="?action=<?php echo $action;?>">全部专家</a></td>
<td>&nbsp;</td>
</tr>
</table>
</div>
...
<?php if($v['lefttime']) { ?>
<span class="f_blue" title="如果逾期未处理，系统将自动付款给卖家"><img src="<?php echo DT_STATIC;?>file/image/clock.gif" width="12" height="12"/> 距处理此专家还剩<?php echo $v['lefttime'];?></span>&nbsp;
...
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=close" onclick="return confirm('确实要删除此交易吗？此操作将不可撤销');">删除专家</a> | 
<?php } ?>
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=detail">专家详情</a>&nbsp;
</span>
&nbsp;专家号：<?php echo $v['itemid'];?>
</td>
</tr>
<tr align="center">
...
<td width="60"><?php echo $v['brand'];?></td>
<td width="120"><?php echo $v['amount'];?></td>
<td width="100"><?php echo $v['addtime'];?></td>
<td width="100"><?php echo $UNIT[$v['level']-1];?></td>
<td width="120">
<?php echo $v['dstatus'];?>
<?php if($v['status'] == 1) { ?>
<?php if($DT['trade']) { ?>
...
<span class="f_r">
<?php if($v['status'] == 0) { ?>
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=edit_price&confirm=1">确认专家</a> | 
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=edit_price">修改专家</a> | 
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=close" onclick="return confirm('确实要关闭此交易吗？此操作将不可撤销');">关闭交易</a> | 
<?php } else if($v['status'] == 1) { ?>
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=edit_price">修改专家</a> | 
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=close" onclick="return confirm('确实要关闭此交易吗？此操作将不可撤销');">关闭交易</a> | 
...
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=print" target="_blank">打印专家</a> | 
<?php } else if($v['status'] == 3) { ?>
<?php if($v['lefttime']) { ?>
<span class="f_blue"><img src="<?php echo DT_STATIC;?>file/image/clock.gif" width="12" height="12"/> 距买家处理专家还剩<?php echo $v['lefttime'];?></span>&nbsp;
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=add_time">延长时间</a> | 
<?php } else { ?>
<span class="f_blue">买家处理专家超时</span>
...
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=close" onclick="return confirm('确实要删除此专家吗？此操作将不可撤销');">删除专家</a> | 
<?php } ?>
<a href="?itemid=<?php echo $v['itemid'];?>&action=update&step=detail">专家详情</a>&nbsp;
</span>
&nbsp;专家号：<?php echo $v['itemid'];?>
...
<?php } else { ?>
<br/><br/><br/><br/><br/>
<center class="px14">当前共收到 <span class="f_red"><?php echo $orders;?></span> 个专家，请<a href="grade.php" class="t">升级您的会员级别</a>获取查看权限</center>
<?php } ?>
<script type="text/javascript">s('trade_expertpool');m('action');</script>
<?php } ?>
