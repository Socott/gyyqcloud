...
<li class="menu_2" id="menu_3" onClick="c(3);">店铺管理</li>
<?php } ?>
...
">我的订单</a></li>
            ...
            <li class="side_a" onMouseOver="v(this.id);" onMouseOut="t(this.id);" id="trade_softpool"><span class="f_r"><a href="trade_softpool.php?action=order" class="m">买家</a></span><a href="trade_softpool.php" class="<?php if($_userid) { ?>n<?php } else { ?>f<?php } ?>
">我的软件订单</a></li>
            
            <li class="side_a" onMouseOver="v(this.id);" onMouseOut="t(this.id);" id="trade_services"><span class="f_r"><a href="trade_services.php?action=order" class="m">买家</a></span><a href="trade_services.php" class="<?php if($_userid) { ?>n<?php } else { ?>f<?php } ?>
">我的服务订单</a></li>
            <li class="side_a" onMouseOver="v(this.id);" onMouseOut="t(this.id);" id="trade_expertpool"><span class="f_r"><a href="trade_expertpool.php?action=order" class="m">买家</a></span><a href="trade_expertpool.php" class="<?php if($_userid) { ?>n<?php } else { ?>f<?php } ?>
">我的专家订单</a></li>
