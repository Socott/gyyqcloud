...
<tr>
<td class="tab" id="add"><a href="?mid=<?php echo $mid;?>&action=add"><span>添加服务</span></a></td>
<?php if($_userid) { ?>
...
<td class="tab" id="trade"><a href="trade_services.php"><span>订单管理<span class="px10">(<?php echo $nums['9'];?>)</span></span></a></td>
<td class="tab" id="type"><a href="javascript:Dwidget('type.php?item=services', '[服务分类]', 600, 300);"><span>服务分类<span class="px10">(<?php echo $nums['0'];?>)</span></span></a></td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 服务名称</td>
...
<td class="tr">
<input name="post[step][a1]" type="hidden" size="10" value="<?php echo $a1;?>" id="a1"/>
<input name="post[step][p1]" type="text" size="10" value="<?php echo $p1;?>" id="p1" onblur="Dstep();"/>
...
<td class="tr"><input name="post[amount]" type="text" size="10" value="999999999" id="amount"/> <input name="post[unit]" type="text" size="2" value="<?php if($unit) { ?><?php echo $unit;?><?php } else { ?>件<?php } ?>
...
<tr>
<td class="tl"><span class="f_red">*</span> 服务详情</td>
...
<td class="tr"><span id="type_box"><?php echo $mycatid_select;?></span>&nbsp; <a href="javascript:var type_item='mall-<?php echo $_userid;?>',type_name='post[mycatid]',type_default='<?php echo $L['type_default'];?>',type_id=<?php echo $mycatid;?>,type_interval=setInterval('type_reload()',500);Dwidget('type.php?item=services', '[服务分类]', 600, 300);" class="t">[服务分类]</a></td>
</tr>
<tr<?php if(!$_userid) { ?> style="display:none;"<?php } ?>
>
<td class="tl">我的推荐</td>
...
&nbsp;<input type="button" value="新增服务" onclick="add();" class="btn"/></td>
</tr>
</table>
</form>
...
&nbsp;<?php echo category_select('catid', '服务分类', $catid, $moduleid);?>&nbsp;
...
评论：
<input type="text" size="3" name="mincomments" value="<?php echo $mincomments;?>"/> ~ <input type="text" size="3" name="maxcomments" value="<?php echo $maxcomments;?>"/>&nbsp;
</form>
</div>
<div class="ls">
<form method="post">
...
" title="查看订单" onclick="Go('trade_services.php?mallid=<?php echo $v['itemid'];?>');"><?php echo $v['orders'];?></td>
...
f = 'catid_1';
if(Dd(f).value == 0) {
Dmsg('请选择服务分类', 'catid', 1);
return false;
}
f = 'title';
l = Dd(f).value.length;
if(l < 2) {
Dmsg('服务名称最少2字，当前已输入'+l+'字', f);
return false;
}
f = 'price';
l = Dd(f).value;
