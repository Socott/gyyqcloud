...
<?php if($MOD['swfu']==1 && $MG['upload'] && !$DT_TOUCH && check_group($_groupid, $MOD['group_upload'])) { ?>
<tr>
...
<?php } ?>
<td class="f_gray px11"><?php echo $v['download'];?></td>
...
<?php if($MG['down_limit'] || (!$MG['fee_mode'] && $MOD['fee_add'])) { ?>
<div class="limit">
<?php if($MG['down_limit']) { ?>
总共可发 <span class="f_b f_red"><?php echo $MG['down_limit'];?></span> 条&nbsp;&nbsp;&nbsp;
...
/条&nbsp;&nbsp;&nbsp;
可免费发布 <span class="f_b"><?php if($MG['down_free_limit']<0) { ?>无限<?php } else { ?><?php echo $MG['down_free_limit'];?><?php } ?>
</span> 条&nbsp;&nbsp;&nbsp;
<?php } ?>
</div>
<?php } ?>
