...
<tr>
<td class="tab" id="add"><a href="?mid=<?php echo $mid;?>&action=add"><span>添加专家</span></a></td>
<?php if($_userid) { ?>
...
<td class="tab" id="trade"><a href="trade_expertpool.php"><span>预约管理<span class="px10">(<?php echo $nums['9'];?>)</span></span></a></td>
<td class="tab" id="type"><a href="javascript:Dwidget('type.php?item=expertpool', '[专家分类]', 600, 300);"><span>专家分类<span class="px10">(<?php echo $nums['0'];?>)</span></span></a></td>
<td class="tab" id="express"></td>
<?php } ?>
</tr>
</table>
</div>
...
<tr>
<td class="tl"><span class="f_red">*</span> 专家名称</td>
<td class="tr f_gray"><input name="post[title]" type="text" id="title" size="50" value="<?php echo $title;?>"/> （2-30个字 ）<span id="dtitle" class="f_red"></span><?php echo renks_select('post[level]', $level ,array('正高', '副高', '中级', '初级', '院士', '其他'));?></td>
</tr>
...
<td class="tl"><span class="f_red">*</span> 专家价格</td>
<td class="tr">
...
<td><input name="post[step][a1]" type="text" size="10" value="<?php echo $a1;?>1" id="a1"/></td>
<td><input name="post[step][p1]" type="text" size="10" value="<?php echo $p1;?>1" id="p1" onblur="Dstep();"/></td>
<td></td>
<td id="p_a_1"></td>
<td id="p_p_1"></td>
</tr>
...
<tr>
<td class="tl"><span class="f_red">*</span>从业年限</td>
<td class="tr"><input name="post[amount]" type="text" size="10" value="<?php echo $amount;?>" id="amount"/> <input name="post[unit]" type="text" size="2" value="<?php if($unit) { ?><?php echo $unit;?><?php } else { ?>年<?php } ?>
...
<tr>
<td class="tl"><span class="f_red">*</span> 专家详情</td>
...
&nbsp;<?php echo category_select('catid', '专家分类', $catid, $moduleid);?>&nbsp;
...
<div class="b10"></div>
从业年限：
<input type="text" size="3" name="minamount" value="<?php echo $minamount;?>"/> ~ <input type="text" size="3" name="maxamount" value="<?php echo $maxamount;?>"/>&nbsp;
</form>
</div>
<div class="ls">
<form method="post">
...
<td class="f_price"><?php echo $v['brand'];?></td>
<td class="px11 c_p<?php if($v['orders']>0) { ?> f_blue f_b<?php } ?>
" title="查看订单" onclick="Go('trade_expertpool.php?mallid=<?php echo $v['itemid'];?>');"><?php echo $UNIT[$v['level']-1];?></td>
...
f = 'catid_1';
if(Dd(f).value == 0) {
Dmsg('请选择专家分类', 'catid', 1);
return false;
}
f = 'title';
l = Dd(f).value.length;
if(l < 2) {
Dmsg('专家名称最少2字，当前已输入'+l+'字', f);
return false;
}
f = 'price';
l = Dd(f).value;
