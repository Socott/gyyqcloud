...
<tr>
<td class="tab" id="add"><a href="?mid=<?php echo $mid;?>&action=add"><span>添加软件</span></a></td>
<?php if($_userid) { ?>
...
<td class="tab" id="trade"><a href="trade_softpool.php"><span>订单管理<span class="px10">(<?php echo $nums['9'];?>)</span></span></a></td>
<td class="tab" id="type"><a href="javascript:Dwidget('type.php?item=softpool', '[软件分类]', 600, 300);"><span>软件分类<span class="px10">(<?php echo $nums['0'];?>)</span></span></a></td>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_red">*</span> 软件分类</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 软件名称</td>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_red">*</span> 软件价格</td>
<td class="tr">
...
<tr>
<td class="tl"><span class="f_red">*</span> 软件库存</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 软件详情</td>
...
<td class="tr"><span id="type_box"><?php echo $mycatid_select;?></span>&nbsp; <a href="javascript:var type_item='mall-<?php echo $_userid;?>',type_name='post[mycatid]',type_default='<?php echo $L['type_default'];?>',type_id=<?php echo $mycatid;?>,type_interval=setInterval('type_reload()',500);Dwidget('type.php?item=softpool', '[软件分类]', 600, 300);" class="t">[管理分类]</a></td>
</tr>
<tr<?php if(!$_userid) { ?> style="display:none;"<?php } ?>
>
<td class="tl">我的推荐</td>
...
&nbsp;<input type="button" value="新增软件" onclick="add();" class="btn"/></td>
</tr>
</table>
</form>
...
&nbsp;<?php echo category_select('catid', '软件分类', $catid, $moduleid);?>&nbsp;
...
" title="查看订单" onclick="Go('trade_softpool.php?mallid=<?php echo $v['itemid'];?>');"><?php echo $v['orders'];?></td>
...
<td>
<a href="?mid=<?php echo $mid;?>&action=relate&itemid=<?php echo $v['itemid'];?>"><img width="16" height="16" src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/child.png" title="关联软件" alt=""/></a>
...
f = 'catid_1';
if(Dd(f).value == 0) {
Dmsg('请选择软件分类', 'catid', 1);
return false;
}
f = 'title';
l = Dd(f).value.length;
if(l < 2) {
Dmsg('软件名称最少2字，当前已输入'+l+'字', f);
return false;
}
f = 'price';
l = Dd(f).value;
