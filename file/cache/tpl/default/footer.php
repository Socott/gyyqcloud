...
<div class="detail_scroll">
    <div class="scroll_list">
        ...
        <div class="scroll_share">
            <div class="scroll_share_img"><img src="https://cdn.htres.cn/res/images/news/news_gzh_img.png" alt="关注公众号"></div>
            <div class="scroll_share_text">关注公众号</div>
        </div>
    </div>
    <div class="scroll_list">
        <div id="goBack"></div>
        <span class="go_back">返回顶部</span>
    </div>
</div>
<div class="phone_go_back"><span></span></div>
        ...
        <div class="footer-content row clearfix">
            <div class="col-xs-12 col-sm-3">
                <div class="footer_contact">
                    <div>市场商务</div>
                    <div>023-85238885</div>
                    <i class="market_phone"></i>
                </div>
                <div class="footer_contact">
                    <div>客服热线</div>
                    <div>400-008-2859</div>
                    <i class="service_phone"></i>
                </div>
                <div class="footer_contact">
                    <div class="footer_contact_address">地址：重庆市大足区昌州街国际会展中心2层</div>
                </div>
                ...
                <div class="show_footer_iphone">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <span>市场商务</span>
                            <span class="iphone5_block"><a href="tel:023-85238885">023-85238885</a></span>
                            <i class="market_phone"></i>
                        </div>
                        <div class="col-xs-6">
                            <span>客服热线</span>
                            <span class="iphone5_block"><a href="tel:400-008-2859">400-008-2859</a></span>
                            <i class="service_phone"></i>
                        </div>
                    </div>
                    <div>地址：重庆市大足区昌州街国际会展中心2层</div>
                </div>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-2 hidden-xs">
                        <div class="footer-item about-us">
                            ...
                            <ul class="footer-link-list">
                                <li><a target="_blank" href="/aboutus.html">重庆工业云平台</a></li>
                                <li><a target="_blank" href="http://www.jxicloud.com/">江西重庆工业云平台</a></li>
                                <li><a target="_blank" href="http://www.gz-icloud.com.cn/">贵州重庆工业云平台</a></li>
                                <li><a target="_blank" href="http://xiaogan.casicloud.com/">孝感重庆工业云平台</a></li>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-2 hidden-xs">
                        <div class="footer-item">
                            ...
                            <div class="footer-qrcode">
                                <img src="https://cdn.htres.cn/res/images/htyw_app.png?20170302" alt="重庆工业云APP"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-2 hidden-xs">
                        <div class="footer-item">
                            ...
                            <div class="footer-qrcode">
                                <img src="https://cdn.htres.cn/res/images/htyw_ewm.png?20170213" alt="关注重庆工业云"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<li><a href="http://www.casicloud.com/links.html" target="_blank">更多</a></li>
        ...
        <div class="footer-copyright col-xs-12">
            <ul class="az-inline-block-list">
                <li>
                    <span><?php echo $DT['copyright'];?><?php if($DT['icpno']) { ?> | <a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow"><?php echo $DT['icpno'];?></a><?php } ?>
</span>
                </li>
                <li>
                    <span></span>
