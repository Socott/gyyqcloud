    ...
    <div class="container">
        <div class="header_news clearfix">
            ...
            <div class="logo_key fl">
                <div class="phone_line"><i></i>求购信息</div>
            </div>
            ...
            <div class="search_nav_box">
                <div class="nav_box">
                    <ul class="nav_box_ul clearfix" id="tab_list">
                        <li><a href="searchr.html?q=产品">产品</a></li>
                        <li><a href="searchr.html?type=1&amp;q=能力">能力</a></li>
                        <li><a href="searchr.html?type=1&amp;detailtype=1&amp;q=创意">创意</a></li>
                        <li><a href="searchr.html?type=1&amp;detailtype=2&amp;q=生产性服务">生产性服务</a></li>
                        <li><a href="searchr.html?type=1&amp;detailtype=4&amp;q=综合性服务">综合性服务</a></li>
                        <li><a href="searchr.html?type=1&amp;detailtype=3&amp;q=商业性服务">商业性服务</a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="search_category_box clearfix">
                ...
                <div class="fr category_time">
                    共找到&nbsp;<span class="highlight">999</span>&nbsp;件<span class="double_mark">“</span><span class="double_mark">”</span>相关求购信息
                        （用时0.01秒）
                    </div>
            </div>
        </div>
            ...
            <div class="search_type_box">
                <div class="buySearch_type_content clearfix">
                    ...
                    <div class="right" id="subscriptionCategory">
                        <span data-id='10066983' data-value='电子元器件'>
                        <a  id='10066983' title='电子元器件' href="searchr.html?q=&amp;catename=%E7%94%B5%E5%AD%90%E5%85%83%E5%99%A8%E4%BB%B6&amp;order=&amp;asc=0">电子元器件</a>
                        </span> 
                    </div>
        ...
        <div class="container">
            <div class="search_data_box clearfix">
                <div class="search_mod fl">
                    <div class="clearfix">                  <?php $tags=tag("moduleid=$moduleid&condition=status=3$dtype&catid=$catid&areaid=$cityid&pagesize=".$MOD['pagesize']."&page=$page&showpage=1&datetype=5&order=".$MOD['order']."&fields=".$MOD['fields']."&lazy=$lazy&template=null&debug=0");?>
                        ...
                        <div class="mod_unit">
                                    <div class="mod_unit_box">
                                        <div class="unit_top">
                                           ...
                                           <div class="unit_top_num"><a href="<?php echo $t['linkurl'];?>" target="_blank">采购量：<span class="num_label"><?php echo $t['amount'];?>套</span></a></div>
                                      </div>
                                            ...
                                            <div class="unit_middle_box">
                                                <a href="<?php echo $t['linkurl'];?>" target="_blank">
                                                    <div class="unit_content">
                                                        <span>发布时间：</span>
                                                        <span class="unit_label"> <?php echo $t['editdate'];?></span>
                                                    </div>
                                                    <div class="unit_content">
                                                        <span>剩余时间：</span>
                                                        <span class="days"><?php if($todate) { ?><?php echo $todate;?><?php } else { ?>长期有效<?php } ?>
<?php if($expired) { ?> <span class="f_red">[已过期]</span><?php } ?>
                                            ...
                                            <div class="unit_conname">
                                                <a href="<?php echo $member['linkurl'];?>" target="_blank" title="<?php echo $t['company'];?>"><?php echo $t['company'];?></a>
                                            </div>
                                        ...
                                        <div class="unit_bottom">
                                            <a href="#" target="_blank" onclick="Go('<?php echo $MOD['linkurl'];?><?php echo rewrite('price.php?itemid='.$t[itemid]);?>');">立即报价</a>
                                        </div>
                                    </div>
                      </div>
                         <?php } } ?> 
