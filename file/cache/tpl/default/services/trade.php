...
<tr>
<td class="tab" id="action"><a href="?action=index"><span>我的服务(我是卖家)</span></a></td>
<td class="tab" id="action_order"><a href="?action=order"><span>购买的服务(我是买家)</span></a></td>
...
<script type="text/javascript">s('trade_services');m('action_express');</script>
...
<div class="pages"><?php echo $pages;?></div>
<script type="text/javascript">s('trade_services');m('action_order');</script>
<?php } else { ?>
...
<?php } ?>
<script type="text/javascript">s('trade_services');m('action');</script>
<?php } ?>
