...
class down {
    ...
    function __construct($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','tag','thumb','fileurl','fileext','filesize','unit','status','hits','download','username','addtime','editor','edittime','ip','template', 'linkurl','filepath','note','format','version');
    }
	...
	function set($post) {
		...
		$post['format'] = stripslashes($post['format']);
		$post['version'] = stripslashes($post['version']);
