...
if($_username && in_array($action, array('add', 'edit'))) {
	$result = $db->query("SELECT * FROM {$DT_PRE}softpool_express WHERE username='$_username' AND parentid=0 ORDER BY listorder ASC,itemid ASC LIMIT 100");
