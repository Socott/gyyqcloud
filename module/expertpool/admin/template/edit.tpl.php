...
<td><input name="post[title]" type="text" id="title" size="60" value="<?php echo $title;?>"/> <?php echo renks_select('post[level]', $level ,array('正高', '副高', '中级', '初级', '院士', '其他'));?> <?php echo dstyle('post[style]', $style);?> <br/><span id="dtitle" class="f_red"></span></td>
</tr>
...
<td><input name="post[step][a1]" type="text" size="10" value="1<?php echo $a1;?>" id="a1"/></td>
<td><input name="post[step][p1]" type="text" size="10" value="1<?php echo $p1;?>" id="p1" onblur="Dstep();"/></td>
<td></td>
<td id="p_a_1"></td>
<td id="p_p_1"></td>
</tr>
...
<tr>
<td class="tl"><span class="f_red">*</span> 专家图片</td>
<td>
