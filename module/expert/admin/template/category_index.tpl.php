...
<td><input type="checkbox" name="cate_id[]" value="<?php echo $v['cate_id'];?>"/></td>
<td><a href="<?php echo $v['caturl'];?>" target="_blank"><?php echo $v['title'];?></a></td>
<td><?php echo $v['create_time'];?></td>
<td>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit&cate_id=<?php echo $v['cate_id'];?>"><img src="admin/image/edit.png" width="16" height="16" title="修改" alt=""/></a>&nbsp;
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete&cate_id=<?php echo $v['cate_id'];?>" onclick="return _delete();"><img src="admin/image/delete.png" width="16" height="16" title="删除" alt=""/></a>
</td>
<td></td>
</tr>
<?php } ?>
