...
<td>
	<div class="msg">
		...
		<tr>
		<td colspan="2" height="50"><a href="#" target="_blank"><img src="admin/image/spacer.gif" width="290" height="30" title="Powered By www.gyycloud.com" alt=""/></a></td>
		</tr>
		<tr>
		...
		<tr>
		<td></td>
		<td><input type="submit" name="submit" value="登 录" class="btn" tabindex="4" id="submit" style="color:#FFF;"/>&nbsp;&nbsp;<input type="button" value="退 出" class="btn" onclick="top.Go('<?php echo DT_PATH;?>');" style="color:#FFF;"/>
		</td>
		</tr>
		</table>
		</form>
	...
	<div style="margin:10px 40px 0 40px;border:#FF8D21 1px solid;background:#FFFFDD;padding:8px;display:none;" id="tips"><img src="admin/image/notice.gif" align="absmiddle"/> 提示：为了系统安全，请尽快修改后台地址 &nbsp;<a href="http://www.longygo.com/doc/use/34.html" target="_blank" style="color:#006699;">帮助&#187;</a></div>
